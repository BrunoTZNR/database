...
select nome, dtlocacao, dtentrega, placa, modelo, ano from tbaluguel al join tbcarro c on al.codcar = c.codcar join tbcliente cli on cli.id = al.codcli order by codalug;